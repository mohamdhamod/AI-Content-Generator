...
<body>
    <div class="container">
        <div class="header">
            <div class="logo">🏥 MedContent AI</div>
        </div>
        ...
        <div class="content">
            ...
            <div class="new-user-box">
                <h3>🎉 {{ __('Welcome to MedContent AI!') }}</h3>
                <p>{{ __('You\'re new here! MedContent AI is a powerful platform for generating medical content using AI.') }}</p>
                <div class="features">
                    <span class="feature">🤖 {{ __('AI Content Generation') }}</span>
                    <span class="feature">🏥 {{ __('Medical Specialties') }}</span>
                    <span class="feature">🌍 {{ __('Multi-language') }}</span>
                    <span class="feature">📊 {{ __('SEO Optimization') }}</span>
                </div>
        ...
        <div class="footer">
            <p>{{ __('This email was sent by MedContent AI') }}</p>
            <p>© {{ date('Y') }} MedContent AI. {{ __('All rights reserved.') }}</p>
        </div>
    </div>
</body>
</html>
