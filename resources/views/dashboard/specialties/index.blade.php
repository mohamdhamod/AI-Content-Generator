                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    @foreach($specialties as $model)
                                        <tr>
                                            ...
                                            <td class="actions">
                                                <!-- Topics button -->
                                                <a href="{{ route('specialties.topics.index', ['specialty' => $model->id]) }}"
                                                   class="btn btn-sm btn-outline-info"
                                                   data-bs-toggle="tooltip"
                                                   data-bs-placement="top"
                                                   title="{{ __('translation.specialties.manage_topics') }}">
                                                    <i class="bi bi-tags"></i>
                                                    <span class="badge bg-info ms-1">{{ $model->topics->count() }}</span>
                                                </a>
