@php
    ...
    switch ($page) {
        ...
        case 'subscriptions':
            $i18n_page = [
                'table' => [
                    'name' => __('translation.subscription.form.fields.name'),
                    'price' => __('translation.subscription.form.fields.price'),
                    'currency' => __('translation.subscription.form.fields.currency'),
                    'duration_months' => __('translation.subscription.form.fields.duration_months'),
                    'max_content_generations' => __('translation.subscription.form.fields.max_content_generations'),
                    'description' => __('translation.subscription.form.fields.description'),
                    'digistore_product_id' => __('translation.subscription.form.fields.digistore_product_id'),
                    'status' => __('translation.subscription.status'),
                    'created_at' => __('translation.subscription.created_at'),
                ],
                'labels' => [
                    'id' => __('translation.subscription.id'),
                    'name' => __('translation.subscription.form.fields.name'),
                    'price' => __('translation.subscription.form.fields.price'),
                    'currency' => __('translation.subscription.form.fields.currency'),
                    'duration_months' => __('translation.subscription.form.fields.duration_months'),
                    'months' => __('translation.subscription.months'),
                    'max_content_generations' => __('translation.subscription.form.fields.max_content_generations'),
                    'description' => __('translation.subscription.form.fields.description'),
                    'digistore_product_id' => __('translation.subscription.form.fields.digistore_product_id'),
                    'status' => __('translation.subscription.status'),
                    'active' => __('translation.subscription.active'),
                    'inactive' => __('translation.subscription.inactive'),
                    'created_at' => __('translation.subscription.created_at'),
                ],
                'form' => [
                    'title_edit' => __('translation.subscription.form.modal.title_edit'),
                    'title_add' => __('translation.subscription.form.modal.title_add'),
                    'btn_update' => __('translation.subscription.form.buttons.update'),
                    'btn_save' => __('translation.subscription.form.buttons.save'),
                ],
            ];
